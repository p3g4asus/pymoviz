...
p4a apk --private /home/matteo/python-for-android/pymoviz/src --package=org.kivymfz.pymoviz.test --name "PyMovizTest" --version 1.0 --bootstrap=sdl2 --requirements=libffi,python3,python-osc,kivy,setuptools,kivymd,aiosqlite,able --debug --permission INTERNET --permission WRITE_EXTERNAL_STORAGE --permission READ_EXTERNAL_STORAGE --permission FOREGROUND_SERVICE --permission ACCESS_COARSE_LOCATION --permission BLUETOOTH --dist-name pymoviz_test_apk --service=BluetoothService:./service/bluetooth_service.py
